...
!!! info
    ...
    **Source Code Repository:** [https://github.com/fpetk-rolling-demo/test-chatbot-2026030501](https://github.com/fpetk-rolling-demo/test-chatbot-2026030501)

    **GitOps Repository:** [https://github.com/fpetk-rolling-demo/test-chatbot-2026030501-gitops](https://github.com/fpetk-rolling-demo/test-chatbot-2026030501-gitops)

# **Usage**

To access the test-chatbot-2026030501 application that was deployed using the Software Template, complete the following instructions:
