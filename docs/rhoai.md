...
3) Access the `workbench` named `test-chatbot-2026030501-notebook`.
...
5) In the terminal, run `cd test-chatbot-2026030501` to navigate to your sample app's directory.
